...
import controller.TelaTarefasConcluidasController;
 ...
 * @author Felipe
 */
public class TelaTarefasConcluidas extends javax.swing.JFrame {

    private DefaultListModel listTarefasModel;
    private TelaTarefasConcluidasController telaTarefasConcluidasController;
    /**
     * Creates new form TelaTarefasConcluidas
     */
    public TelaTarefasConcluidas() {
        this.telaTarefasConcluidasController = new TelaTarefasConcluidasController(this);
        initComponents();
        telaTarefasConcluidasController.preencher();
    }
    ...
    private void initComponents() {
        ...
        lblDadosCalendario.setText("Tarefas Concluídas");
    ...
    private void btnVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVisualizarActionPerformed
        telaTarefasConcluidasController.visualizar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTarefasConcluidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TelaTarefasConcluidas().setVisible(true);
            }
        });
    }
